...
- **Unity Simulation Environment** ([evaaa_unity](https://anonymous.4open.science/r/evaaa-2486/evaaa_unity/README.md)): A 3D, multimodal, curriculum-based environment where agents must regulate internal physiological variables (food, water, thermal, damage) to survive and adapt. Built with Unity ML-Agents, supporting rich sensory input and flexible configuration.
- **Python Training Suite** ([evaaa_train](https://anonymous.4open.science/r/evaaa-2486/evaaa_train/README.md)): A modular training and evaluation framework (based on SheepRL) for developing RL agents in the EVAAA environment. Includes implementations of DQN, PPO, and DreamerV3, with tools for logging, evaluation, and curriculum learning.
...
- **`evaaa_unity/`**: Contains the Unity project for the EVAAA simulation environment. See [`evaaa_unity/README.md`](https://anonymous.4open.science/r/evaaa-2486/evaaa_unity/README.md) for setup, configuration, and usage instructions.
- **`evaaa_train/`**: Contains the Python code for training and evaluating RL agents in EVAAA. See [`evaaa_train/README.md`](https://anonymous.4open.science/r/evaaa-2486/evaaa_train/README.md) for installation, training commands, and evaluation details.
...
|-------------------|--------------------------------------------------|---------------------------------------------|
| Unity Environment | 3D simulation, agent embodiment, configuration   | [evaaa_unity](https://anonymous.4open.science/r/evaaa-2486/evaaa_unity/README.md) |
| Python Training   | RL algorithms, logging, evaluation, curriculum   | [evaaa_train](https://anonymous.4open.science/r/evaaa-2486/evaaa_train/README.md) |

- **New to EVAAA?**
  1. Start with the [Unity environment setup](https://anonymous.4open.science/r/evaaa-2486/evaaa_unity/README.md) to explore or customize the simulation.
  2. Then follow the [Python training guide](https://anonymous.4open.science/r/evaaa-2486/evaaa_train/README.md) to train and evaluate RL agents.
